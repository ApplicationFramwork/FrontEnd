...
class declinereserch extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        CmsSevice.getalldeclineresearchdoc(jwt_decord(localStorage.getItem("token")).id).then((res => {
