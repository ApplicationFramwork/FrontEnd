...
class editresearchreview extends Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        ...
        CmsSevice.getrewieusingdocid(this.state.researchid).then((res => {
            this.setState({
                details: res.data,
    ...
    editreview = (e) => {
        ...
        CmsSevice.updatereview(research, this.state.details[0]._id).then(res => {
            console.log('success');
        })
...
export default editresearchreview;